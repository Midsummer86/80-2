	...
	*/
	isSafeUrl:function(_url,oSafeConfig){
		...
		oSafeConfig=oSafeConfig || {
			whiteDomain:['https://game.gtimg.cn/images/js/milo/qq.com','https://game.gtimg.cn/images/js/milo/tencent.com'],//白名单
			blackDomain:['https://game.gtimg.cn/images/js/milo/p.imtt.qq.com']//黑名单
		}
		//合法域名列表
		var whiteDomain=oSafeConfig.whiteDomain || ['https://game.gtimg.cn/images/js/milo/qq.com','https://game.gtimg.cn/images/js/milo/tencent.com'];//白名单
		var blackDomain=oSafeConfig.blackDomain || ['https://game.gtimg.cn/images/js/milo/p.imtt.qq.com'];//黑名单
...
extend(loginStatus,{
	...
	isLegalOrigin:function(url){
		//检测是否合法域名
		//合法域名列表
		var whiteDomain=['https://game.gtimg.cn/images/js/milo/qq.com'];//白名单
		var blackDomain=['https://game.gtimg.cn/images/js/milo/p.imtt.qq.com'];//黑名单
		var isLegal=false;
		var regStr='^(https\\:\\/\\/|http\\:\\/\\/|\\/\\/|)([0-9a-z\-A-Z]+\\.)*reg(\\:[0-9]*){0,1}(\\/{1,2}.*){0,1}$';
		var regWhite=null;
		//判断白名单
